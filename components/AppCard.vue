<template>
	<div id="app">
		<div v-if="cartUIStatus === 'idle'" class="payment">
			...
			<br />
			<input type="email" id="email" v-model="stripeEmail" placeholder="name@example.com" />
			<br />
			<label for="card">Credit Card</label>
			<br />
			<small>
				Test using this credit card: <span class="cc-bumber">4242 4242 4242 4242</span>, and enter any 5 digits for the zip code.
			</small>
			<card
				class="stripe-card"
				id="card"
